...
conf.set("spark.hadoop.fs.defaultFS", "alluxio://alluxio-master.alluxio.marathon.mesos:10102")

sc = pyspark.SparkContext(conf=conf)
file = sc.textFile("hdfs://hdfs/user/jsaba/data_etf.csv")
file.saveAsTextFile("alluxio://alluxio-master.alluxio.marathon.mesos:10102:/user/lpbonenfant/data.csv")
file1 = sc.textFile("alluxio://alluxio-master.alluxio.marathon.mesos:10102:/user/lpbonenfant/data.csv")
