...
conf.set("spark.mesos.constraints", "spark:true;alluxio:true")
conf.set("spark.mesos.driver.constraints", "spark:true;alluxio:true")
...
count = file.filter(lambda x: x).count()
print(count)
